...
<head>
  ...
  <title>List of Psikolog - MengobrolMengobati</title>
  ...
  <div class="container">
    ...
    <div class="page-card">
      ...
      <div class="page-header">
        <h1 class="page-title">List of Psikolog</h1>
          ...
          @foreach($psikologs as $p)
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
              <div class="card doctor-card h-100">
                ...
                @php
                  $photoUrl = $p->photo
                    ? (Str::startsWith($p->photo, ['http://','https://','/']) ? $p->photo : asset('storage/'.$p->photo))
                ...
                <div class="card-body d-flex flex-column">
                  ...
                  <div class="mt-auto d-grid">
                    <a href="{{ route('booking.create', $p->id) }}?type=psikolog" class="btn btn-book">
                      Book
                    </a>
                  </div>
                </div>
      ...
      @else
        <div class="no-data">
          <p>There are currently no registered psikolog.</p>
          {{-- <a href="{{ url('/services') }}" class="back-link">Back to Services</a> --}}
        </div>
      @endif

      @if(method_exists($psikologs, 'links'))
        <div class="mt-4">
          {{ $psikologs->links() }}
        </div>
      @endif
